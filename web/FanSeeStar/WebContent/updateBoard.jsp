				...
				<tbody>
					...
					<form action="updateBoard" method="post">
						<tr>
							...
							<p>
								<td><textarea cols="150" rows="3" name="boardTitle"
						...
						<tr>
							...
							<td><textarea cols="150" rows="15"
									style="overflow-y: scroll" class="form-control" name="boardContent">${board.boardContent } </textarea></td>
						</tr>
						<tr>
						<td colspan="2">
						<input type="hidden" value="${board.boardId }" name="boardId"></input>
						<input type="hidden" value="${board.writer}" name="writer"></input>
						<input type="hidden" value="${board.artistName}" name="artistName"></input>
						<input type="submit" value="수정하기"></input>
						<input type="button" value="목록보기" onclick="history.back(-1)"></input></td>
						</tr>
					</form>
					</c:forEach>
				</tbody>
